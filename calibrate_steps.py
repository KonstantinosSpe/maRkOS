...
C:\\Users\\konstantinos\\Desktop\\maRkOS\\step_accuracy_data.json, so a
...
Run:      .venv\\Scripts\\python.exe calibrate_steps.py
"""
...
BAUD = 115200
OUT_PATH = Path(__file__).with_name("step_accuracy_data.json")
